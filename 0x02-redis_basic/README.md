...
Also, implement two new methods: `get_str` and `get_int` that will automatically parametrize `Cache.get` with the correct conversion function.
...
Hub repository: `alx-backend-storage`
- Directory: `0x02-redis_basic`
- File: `web.py`